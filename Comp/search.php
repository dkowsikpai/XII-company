<?php
echo ("	<head><title>Search Employee</title></head>
	...
	$sql='SELECT * FROM emp WHERE del=0';
			$query=mysql_query($sql);
				echo ("<div class='search_php' name='ins_di'>
					<a class='gray right_button' href='search.html'>Back</a> <a class='gray' href='index.html'>Home</a><br/><br/>  
			...
			while($data=mysql_fetch_array($query)){
					if ($emp_no==$data['emp_no']||$emp_name==$data['name']||$gender==$data['gender']){
							$i++;
							echo ("<tr>"
